            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.create')}}">
                        ...
                        <div class="row mb-3">
                            <label for="identification_type" class="col-md-4 col-form-label text-md-end">{{ __('identification_type') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <label for="identification_number" class="col-md-4 col-form-label text-md-end">{{ __('identification_number') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end">{{ __('confirm_password') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ route('users.index') }}" class="btn btn-secondary" onclick="return confirm('Are you sure you want to cancel?')">{{ __('Cancel') }}</a>
                            </div>
                        </div>
                    </form>
                </div>
